      ...
      <form @submit.prevent="submitForm" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="mb-4">
          ...
          <input
              ...
              id="isbn" type="text" placeholder="Book isbn" v-model="formData.isbn">
        </div>
        <div class="mb-4">
          ...
          <input
              class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="title" type="text" placeholder="Title" v-model="formData.title">
        </div>
        <div class="mb-6">
          ...
          <input
              ...
              id="author" type="text" placeholder="author" v-model="formData.author">
        </div>
...
const API = config.public.LIBRARY_API
definePageMeta({
  layout: 'auth'
})
